            ...
            <div class="row">
                ...
                <thead>
                 ...
                 <?php
                    ...
                    $GenresID = $row_pros['GenresID'];
                    $GenresName = $row_pros['GenresName'];
            ...
            echo "
                <tbody>
                        <tr>
                            ...
                            <td>$GenresName</td>
                            <td>
                                <a href='edit_genres.php?GenresID=$GenresID' class='btn btn-outline-secondary'>Delete</a>
                                <a href='edit_genres.php?GenresID=$GenresID' class='btn btn-outline-secondary'>Update</a>
                            </td>
                        </tr>
                </tbody> 
                ";
